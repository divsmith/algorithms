package Libraries; /******************************************************************************
 *  Compilation:  javac Libraries.In.java
 *  Execution:    java Libraries.In   (basic test --- see source for required files)
 *  Dependencies: none
 *
...
public final class In {
    ...
    ///// begin: section (1 of 2) of code duplicated from Libraries.In to StdIn.
    ...
    //// end: section (1 of 2) of code duplicated from Libraries.In to StdIn.
    ...
    ////  begin: section (2 of 2) of code duplicated from Libraries.In to StdIn,
    ...
    public char readChar() {
        ...
        try {
            ...
            assert ch.length() == 1 : "Internal (Std)Libraries.In.readChar() error!"
    ...
    ///// end: section (2 of 2) of code duplicated from Libraries.In to StdIn */
     ...
     * @deprecated Replaced by {@code new Libraries.In(filename)}.{@link #readAllInts()}.
     */
    @Deprecated
     ...
     * @deprecated Replaced by {@code new Libraries.In(filename)}.{@link #readAllDoubles()}.
     */
    @Deprecated
     ...
     * @deprecated Replaced by {@code new Libraries.In(filename)}.{@link #readAllStrings()}.
     */
    @Deprecated
    ...
    /**
     * Unit tests the {@code Libraries.In} data type.
     *
